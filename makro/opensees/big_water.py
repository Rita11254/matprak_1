...
nx2 = round(water2_width / h * numx)
ny2 = round(water2_height / h * numy)
partArgs2 = ['quad', L, 0.0, 2 * L, 0.0, 2 * L, Hb / 2, L, Hb / 2, nx2, ny2]
ops.mesh('part', 2, *partArgs2, *eleArgs, '-vel', 0.0, 0.0)
